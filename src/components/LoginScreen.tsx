...
const CHALLENGE_SOURCE_TAG = 2606170002; // Jouw toegewezen source tag
      ...
      const res = await fetch('/xaman-api/platform/payload', {
        ...
        body: JSON.stringify({ 
          txjson: { 
            ...
            SourceTag: CHALLENGE_SOURCE_TAG, // CRUCIAAL VOOR LEADERBOARD
      ...
      if (payload.refs?.qr_png) {
        ...
        ws.onmessage = (event) => {
          ...
          if (msg.signed === true) {
            ...
            setQrCodeUrl(null);
            setIsMinting(false);
            onLoginSuccess("rGAs3npYy1VwLPE92kvKvA2QYLR6FSA9n6");
          }
        };
      }
    } catch (e) { 
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-white selection:bg-[#ff2079]/30">
      <div className="text-center space-y-4">
        <img src="/logo.png" className="w-28 mx-auto" alt="Logo" />
      ...
      <div className="w-full max-w-md mt-12">
        {!qrCodeUrl ? (
          ...
          >
            {isMinting ? "VERWERKEN..." : "MINT ACCESS PASS (5 XRP)"}
          </button>
        ) : (
