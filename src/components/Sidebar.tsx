...
import { LayoutDashboard, Coins, GraduationCap, LogOut } from 'lucide-react';
  ...
  return (
    <div className="w-64 border-r border-gray-800 bg-black min-h-screen flex flex-col hidden md:flex font-sans">
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`group w-full flex items-center space-x-3 px-4 py-3 border transition-all ${
                isActive 
      ...
      <div className="p-4 border-t border-gray-800">
        <button className="w-full flex items-center space-x-3 px-4 py-3 text-gray-500 border border-transparent hover:text-white transition-colors group">
