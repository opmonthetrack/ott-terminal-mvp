...
export const MAKE_WAVES_ACTIONS: MakeWavesAction[] = [
  ...
  },
  {
    ...
    description: "Proof that a payload or transaction uses the Make Waves SourceTag.",
  },
  {
    id: "wallet-safety",
    title: "Wallet Safety",
  ...
  },
  {
    ...
    description: "User verified a live XRPL transaction with the correct SourceTag.",
  },
  {
    ...
    description: "Legal-gated eligibility marker for future OTT token rewards.",
  },
];
...
export function isMakeWavesSourceTag(sourceTag: number | null | undefined) {
