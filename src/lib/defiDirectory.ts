...
export const DEFI_DIRECTORY: DefiDirectoryEntry[] = [
  ...
  {
    id: "xmagnetic-review", name: "xMagnetic", category: "dex", verifiedDomain: true, status: "research",
    url: "https://www.xmagnetic.org/", sourceLabel: "xmagnetic.org official platform website",
    summaryEn: "An XRPL and Xahau platform with DEX, swap, AMM, farming, NFT, market and bridge tools. The domain is confirmed; individual products remain research-stage in OTT.",
    summaryNl: "Een XRPL- en Xahau-platform met DEX-, swap-, AMM-, farming-, NFT-, markt- en bridgetools. Het domein is bevestigd; afzonderlijke producten blijven bij OTT in onderzoeksfase.",
    technologyEn: "Interfaces for native XRPL and Xahau trading, liquidity and token functions, plus product-specific applications.",
    technologyNl: "Interfaces voor native XRPL- en Xahau-handel, liquiditeit en tokenfuncties, plus productspecifieke applicaties.",
    possibleBenefitEn: "A broad set of ecosystem and liquidity tools from one platform.", possibleBenefitNl: "Een breed pakket ecosysteem- en liquiditeitstools vanuit één platform.",
    risksEn: ["Trading and liquidity risk", "Product-specific smart-contract or Hook risk", "Phishing and clone risk", "Wallet-signing risk"],
    risksNl: ["Handels- en liquiditeitsrisico", "Productspecifiek smart-contract- of Hook-risico", "Phishing- en kopierisico", "Wallet-signingrisico"],
    custodyEn: "Review each product and signing request separately; domain verification does not establish custody safety.", custodyNl: "Controleer ieder product en ondertekenverzoek apart; domeinverificatie bewijst geen veilige custody.",
    walletEn: "Open only xmagnetic.org and inspect network, destination and transaction fields before signing.", walletNl: "Open uitsluitend xmagnetic.org en controleer netwerk, bestemming en transactievelden vóór ondertekening.",
  },
  {
    id: "onexah-review", name: "One Xahau", category: "xahau", verifiedDomain: true, status: "research",
    url: "https://onexah.io/", sourceLabel: "onexah.io project website",
    summaryEn: "A developing Xahau DeFi project associated with Hooks-based logic. The website is available from OTT while the product remains research-stage.",
    summaryNl: "Een ontwikkelend Xahau-DeFi-project rond Hooks. De website is vanuit OTT beschikbaar, terwijl het product in onderzoeksfase blijft.",
    ...
    custodyEn: "Not yet fully assessed; independently verify every transaction path and product condition.", custodyNl: "Nog niet volledig beoordeeld; controleer ieder transactiepad en elke productvoorwaarde onafhankelijk.",
    walletEn: "Use onexah.io only and do not sign until network, Hook and destination are independently verified.", walletNl: "Gebruik uitsluitend onexah.io en onderteken pas nadat netwerk, Hook en bestemming onafhankelijk zijn gecontroleerd.",
  },
];
